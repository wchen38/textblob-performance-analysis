...
print ( myString)
pdf(file="../data/graphs/t2/t2_1T256_L1MKI.pdf")
#read in csv file
...
plot(data$l2_rqsts.miss ~ data$Timestamp, type="l", col="red", main="thread2:1T/256 inst L2MKI", xlab="timestamp", ylab="measurment")
plot(data$branch.misses ~ data$Timestamp, type="l", col="red", main="thread2:1T/256 inst branchMKI", xlab="timestamp", ylab="measurment")
plot(data$cycles ~ data$Timestamp, type="l", col="red", main="thread2:1T/256 inst IPC", xlab="timestamp", ylab="measurment")
#par(new=TRUE)
