...
print ( myString)
pdf(file="../data/graphs/t1/t1_1T64_L1MKI.pdf")
#read in csv file
...
plot(data$L1.dcache.load.misses ~ data$Timestamp, type="l", col="red", main="thread1: 1T/64 inst L1MKI", xlab="timestamp", ylab="measurment")
